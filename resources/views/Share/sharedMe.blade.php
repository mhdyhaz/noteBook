...
<head>
    ...
    <style>
        ...
        .collapse {
    direction: rtl; /* راست‌چین کردن محتویات درخت */
    text-align: right;
    display: table-row; /* نمایش به عنوان سطر جدول */
}
...
td.collapse-container {
    padding: 0; /* حذف padding اضافی */
        ...
        li {
            text-align: right; /* راست‌چین کردن هر عنصر لیست */
        }
    </style>
</head>
        ...
        <div class="list-container">
            ...
            <table style="text-align: center;" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <button id="eye" class="btn btn-info btn-sm toggle-children" data-target="#collapse-{{ $menu->id }}">
                                <i class="bi bi-eye"></i>
                            </button>
                            <button id="delete" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $menu->id }}">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center">منویی دریافت نشده</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 style="position: absolute;left: 162px;" class="modal-title" id="deleteModalLabel-{{ $menu->id }}">حذف منو دریافت شده</h5>
